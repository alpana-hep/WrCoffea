...
#                dy.append(rebinned_hist.GetBinContent(bin) / bin_width * 59.74 * 1000)
#                dy_err.append(rebinned_hist.GetBinError(bin) / bin_width * 59.74 * 1000)
            elif process == 'tt+tW':
                ttbar.append(rebinned_hist.GetBinContent(bin) * 59.74 * 1000)
                ttbar_err.append(rebinned_hist.GetBinError(bin) * 59.74 * 1000)
#                ttbar.append(rebinned_hist.GetBinContent(bin) / bin_width * 59.74 * 1000)
#                ttbar_err.append(rebinned_hist.GetBinError(bin) / bin_width * 59.74 * 1000)
...
#                nonprompt.append(rebinned_hist.GetBinContent(bin) / bin_width * 59.74 * 1000)
#                nonprompt_err.append(rebinned_hist.GetBinError(bin) / bin_width * 59.74 * 1000)
...
#                other.append(rebinned_hist.GetBinContent(bin) / bin_width * 59.74 * 1000)
#                other_err.append(rebinned_hist.GetBinError(bin) / bin_width * 59.74 * 1000)
    ...
    output_path = os.path.join("plots", channel, mll,  f"{hist_name}_01009.png")
