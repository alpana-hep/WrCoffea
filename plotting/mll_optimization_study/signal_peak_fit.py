...
def plot_signal_hist(channel, mll, hist_name, bins, mlljj_values, sig_mean, signal_stddev):
    ...
    # Save the plot
    plt.savefig(f'plotting/mll_optimization_study/{hist_name}_signal_peak_{channel}.png')
    print(f"Saved plotting/mll_optimization_study/{hist_name}_signal_peak_{channel}.png\n")
