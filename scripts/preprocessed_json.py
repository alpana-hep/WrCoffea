...
def main():
    ...
    if "Muon" in args.process or "EGamma" in args.process:
        ...
        input_file = Path("/uscms/home/bjackson/nobackup/WrCoffea/data/configs") / run / year / args.era / f"{args.era}_mc_ptll_dy.json" #f"{args.era}_mc.json", f"{args.era}_mc_nlo_dy.json"
