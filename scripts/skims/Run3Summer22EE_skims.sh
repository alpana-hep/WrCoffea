...
for ((i=1; i<=125; i+=1))
do
    python3 skim_files.py Run3Summer22EE DYto2L-4Jets_MLL-120_HT-40to70 --start $i
done

for ((i=1; i<=107; i+=1))
do
    python3 skim_files.py Run3Summer22EE DYto2L-4Jets_MLL-120_HT-70to100 --start $i
done

for ((i=1; i<=77; i+=1))
do
    python3 skim_files.py Run3Summer22EE DYto2L-4Jets_MLL-120_HT-100to400 --start $i
done

for ((i=1; i<=122; i+=1))
do
    python3 skim_files.py Run3Summer22EE DYto2L-4Jets_MLL-120_HT-400to800 --start $i
done

for ((i=1; i<=132; i+=1))
do
    python3 skim_files.py Run3Summer22EE DYto2L-4Jets_MLL-120_HT-800to1500 --start $i
done

for ((i=1; i<=135; i+=1))
do
    python3 skim_files.py Run3Summer22EE DYto2L-4Jets_MLL-120_HT-1500to2500 --start $i
done
